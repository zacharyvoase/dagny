...
class AtomPubRoutingTest(DefaultRoutingTest):
    ...
    def test_index(self):
        ...
        self.assert_resolves('/users-atompub/', resources.UserAtomPub,
                             methods=COLLECTION_METHODS)

    def test_show(self):
        self.assertEqual(reverse('UserAtomPub#show', args=(1,)),
                         '/users-atompub/1')
        self.assert_resolves('/users-atompub/1', resources.UserAtomPub,
                             '1', methods=MEMBER_METHODS)
    ...
    def test_new(self):
        ...
        self.assert_resolves('/users-atompub/new', resources.UserAtomPub,
                             methods=NEW_METHODS)

    def test_edit(self):
        self.assertEqual(reverse('UserAtomPub#edit', args=(1,)),
                         '/users-atompub/1/edit')
        self.assert_resolves('/users-atompub/1/edit', resources.UserAtomPub,
                             '1', methods=EDIT_METHODS)
...
class RailsRoutingTest(DefaultRoutingTest):
    ...
    def test_index(self):
        ...
        self.assert_resolves('/users-rails', resources.UserRails,
                             methods=COLLECTION_METHODS)
        self.assert_resolves('/users-rails/', resources.UserRails,
                             methods=COLLECTION_METHODS)
    ...
    def test_index_with_format(self):
        self.assertEqual(reverse('UserRails#index', kwargs={'format': '.json'}),
                         '/users-rails.json')
        self.assert_resolves('/users-rails.json', resources.UserRails,
    ...
    def test_new(self):
        ...
        self.assert_resolves('/users-rails/new', resources.UserRails,
                             methods=NEW_METHODS)
        self.assert_resolves('/users-rails/new/', resources.UserRails,
                             methods=NEW_METHODS)
    ...
    def test_edit(self):
        self.assertEqual(reverse('UserRails#edit', kwargs={'id': 1}),
                         '/users-rails/1/edit')
        self.assert_resolves('/users-rails/1/edit', resources.UserRails,
